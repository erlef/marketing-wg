...
After about three days of focused work, I ended up with this [OTP patch](https://github.com/erlang/otp/commit/d7e0b82835312a0458e276f4663bb432574a26d6.patch)
...
Download an older QNX Software Download Center
Activate a license and install the QNX SDP (QNX SDP 8 in my case)
Use Docker to run QNX tooling, following this [QNX guide](https://devblog.qnx.com/how-to-use-macos-to-develop-for-qnx-8-0/)
Enable the SDK environment source qnx800/qnxsdp-env.sh
Cross-compile Erlang using OTP’s existing xcomp support
Create a QNX image using mkqnximage
Add Erlang to the image
Run the image in QEMU (via UTM)
Open a serial console and start Erlang
